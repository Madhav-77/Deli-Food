...
<head>
    ...
    <body>
        ...
        <div id="signup" class="modal modal-fixed-footer" style="height: 70%; width: 40%;">
                ...
                <div class="row">
                    <form class="col s12" method="post" action="index2.php">
                        ...
                        <div class="row">
                            <div class="input-field col s12" style="margin-bottom: 0px;">
                            <label>
                                <input class="with-gap" name="pref" type="radio" checked />
                                <span>Vegeterian</span>
                            <label>
                            </label>
                                <input class="with-gap" name="pref" type="radio" />
            ...
            <div class="modal-footer center">
                <a href="#!" class="modal-close waves-effect waves-green btn-flat">Already a member?</a>
            </div>
        </div>
