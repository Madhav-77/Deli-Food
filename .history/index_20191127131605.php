...
<body>
            ...
            <div class="row">
                <form class="col s12" method="post" action="index.php">
                    ...
                    <div class="row">
                        <div class="input-field col s12" style="margin-bottom: 0px;">
                            <p>
                                ...
                                <label>
                                    <input class="with-gap type" name="type" type="radio" value="Customer" checked />
                                    <span>Customer?</span>
                                </label>
                                <label>
                                    <input class="with-gap type" name="type" type="radio" value="Restaurant" />
                    ...
                    <div class="file-field input-field hide">
                        <div class="btn">
                            <span>File</span>
                            <input type="file" name="r_image" id="r_image" value="insert">
                        </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12" style="margin-bottom: 0px; margin-top: 0px;">
                            <button style="background-color: #F44336;" class="btn waves-effect waves-light" id="add" type="submit" name="reg_user">Submit
                                <i class="material-icons right">send</i>
                            </button>
                        </div>
                    </div>
    ...
    <footer id="contactUs" class="scrollspy page-footer grey darken-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col l6 s12">
                    <p class="grey-text text-lighten-4">
                        <div id="map-container-google-11" class="z-depth-1-half map-container-6" style="height: 400px">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d60532.572656792436!2d73.81509!3d18.515983!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x771e89770c4697a3!2sMIT+School+of+Management!5e0!3m2!1sen!2sin!4v1561132760347!5m2!1sen!2sin" width="450" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
                    </p>
                </div>
        ...
        <div class="footer-copyright black scrollspy">
            <div class="container">
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#add").on('click', function() {
                var img_name = $('#r_image').val();
                if (img_name == '') {
                    alert('please select image');
                    return false;
                } else {
                    var extension = $('#r_image').val().split('.').pop().toLowerCase();
