    ...
    <div class="navbar-fixed">
        <nav style="background-color: #F44336;">
            <div class="nav-wrapper">
                <a href="index.php" class="brand-logo white-text" style="padding-left: 20px;">Deli-Food</a>
        ...
        <div class="row">
            <?php
                ...
                if($id == 1){
                    ...
                    if($food_type != 'Both'){
                        $sql = mysqli_query($db, "SELECT * FROM user_master WHERE preference = '$food_type' AND user_type = 'Restaurant'");
                    }else{
