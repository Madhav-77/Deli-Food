...
<form id="tests" method="POST"><input id="hid" type="hidden" name="hid" value="hid"><input type="submit" id="hidsub"><div class="order-place"> </div></form>
