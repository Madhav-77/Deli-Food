...
<div class="row">
    ...
    <div class="row">
        ...
        <?php }else{?>
            <a href="#basket" class="btn waves-effect waves-light order" type="submit" style="background: #F44336; float: right;">Go to Basket
...
<?php if($id == 1) {?>
<h5 class="hide basket-ord"><?= $_SESSION['username']; ?>'s Basket</h5>
<div class="order-place"> </div>
<a href="#!" class="basket-ord hide btn waves-effect waves-light" type="submit" style="background: #F44336; float: right;">Place Order
    <i class="material-icons right">shopping_basket</i>
</a>
<?php }?>
