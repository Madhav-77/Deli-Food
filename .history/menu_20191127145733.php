    ...
    <div class="container" style="margin-top: 70px;">
        ...
        <div class="row">
            ...
            if ($id == 1) {
                ...
                if ($food_type == 'Veg') {
                    $sql = mysqli_query($db, "SELECT * FROM menu WHERE food_type = 'Veg' AND user_id = '$u_id'");
                } elseif($food_type == 'Non-Veg') {
                    $sql = mysqli_query($db, "SELECT * FROM menu WHERE food_type = 'Non-Veg' AND user_id = '$u_id'");
                } else {
        ...
        <div class="row">
            <div class="col s6 m3" style="float: left; margin-bottom: 30px;">
                <?php if ($id == 0) { ?>
