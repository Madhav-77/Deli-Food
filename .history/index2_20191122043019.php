...
<head>
    ...
    <div class="fixed-action-btn">
        ...
        <ul>
            <li><a class="btn-floating red"><i class="material-icons">library_books</i></a></li>
    ...
    <body>
        <div class="head carousel carousel-slider">
            <a class="carousel-item" href="#one!"><h2 class="test">First Panel</h2>
      <p class="test white-text">This is your first panel</p><img class="img-carousel" src="images\image1.jpg"></a>
