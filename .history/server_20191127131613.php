...
if (isset($_POST['reg_user'])) {
  ...
  $file = addslashes(file_get_contents($_FILES['r_image']['tmp_name']));
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO user_master (u_name, u_email, password, u_contact, preference, u_city, user_type, r_image) 
  			  VALUES('$username', '$email', '$password', '$contact', '$pref', '$city', '$type', '$file')";
    ...
    if($logged_in_users['user_type'] == "Customer"){
      $_SESSION['id'] = $logged_in_users['user_id'];;
