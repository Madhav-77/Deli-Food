    ...
    <nav style="background-color: #F44336;">
      <div class="nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
          <?php if($id == 1) {?>
            <li><a class="white-text order" href="#!">View Basket</a>
...
<div class="row">
    ...
    <div class="row">
        ...
        <?php }else{?>
            <a href="#!" class="btn waves-effect waves-light order"  type="submit" style="background: #F44336; float: right;">Go to Basket
...
<?php if($id == 1) {?>
<h5 class="d-none order-place"><?= $_SESSION['username']; ?>'s Basket</h5>
...
$('.basket').on('click', function(){
    ...
    if(count!=0){
        ...
        $('.order-place').removeClass('d-none');
    }
});
