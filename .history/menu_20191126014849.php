...
$('.plus').on('click', function(){
    ...
    var test = [{name: name, price: price, count: counter, total: total}];
    //console.log(test);
    var i;
    
    for(i=0; i<test.length; i++){
        $('#place-order').html("<tr><td>"+test[i][name]+"</td><td>"+test[i][price]+"</td><td>"+test[i][counter]+"</td><td>"+test[i][total]+"</td></tr>");
    }
});
