...
<div class="row">
    ...
    <div class="row">
        ...
        <?php if($id == 0) {?>
        <a href="#login" id="order" class="btn waves-effect waves-light modal-trigger" style="height: 30px; background: #F44336; border: 0px; text-align: center;" type="submit" name="order">Order Food
