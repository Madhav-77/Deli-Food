...
<div class="row">
    <div class="col s6 m3">
        <div class="card">
            ...
            <a class="waves-effect waves-teal btn-flat">Button</a><i class="minus material-icons">remove</i></a>
...
$('.minus').on('click', function(){
    var $n = $(this).parent('.btn-floating').parent('.card-action').find('.counter');
    var counter = $n.text();
    if(counter!=0){
        counter--;
    }
