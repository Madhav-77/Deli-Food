        ...
        <div class="navbar-wrapper">
            <div class="navbar-static">
                ...
                box-shadow:0 0px 0px 0 rgba(0, 0, 0, 0), 0 0px 0px 0px rgba(0, 0, 0, 0), 0 0px 0px 0 rgba(0, 0, 0, 0);">
                    <a href="#" class="white-text brand-logo sidenav-trigger" data-target="slide-out"><i class="material-icons">menu</i></a>
                </nav>
                ...
                <a href="#" class="white-text brand-logo" data-target="slide-out" class="sidenav-trigger"><i class="material-icons">menu</i></a>
