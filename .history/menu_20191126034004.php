...
$('.minus').on('click', function(){
    ...
    if(counter!=0){
        counter--;
        var name = $(this).parentUntil('.card-action').siblings('.card-content').find('p:nth-child(1)').text();
        var price = $(this).parentUntil('.card-action').siblings('.card-content').find('p:nth-child(3)').text();
        var count = counter;
