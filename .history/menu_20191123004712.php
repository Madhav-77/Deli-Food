...
<div class="row">
    ...
    <div class="row">
        <div class="col s6 m3">
            <button id="order" class="btn waves-effect waves-light" type="submit" name="order">Order Food
            ...
            <form class="col s12" method="post" action="index.php">
                ...
                <div class="row">                          
                    <div class="input-field col s12" style="margin-bottom: 0px; margin-top: 0px;">
                        <button style="background-color: #F44336;" class="btn waves-effect waves-light modal-trigger" type="submit" name="login">Submit
                            <i class="material-icons right">send</i>
                        </button>        
                    </div>
                </div>
