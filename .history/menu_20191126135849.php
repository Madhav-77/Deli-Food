    ...
    <nav style="background-color: #F44336;">
      <div class="nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
          <?php if($id == 1) {?>
            <li><a class="dropdown-trigger white-text" href="#!" data-target="user_drop" id="order" name="order">View Basket</a>
...
<?php if($id == 1) {?>
    <a href="#" class="btn waves-effect waves-light" type="submit" id="order" name="order">Go to Basket
