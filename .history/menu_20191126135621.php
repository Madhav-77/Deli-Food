    ...
    <nav style="background-color: #F44336;">
      <div class="nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
          <?php if($id == 1) {?>
            <li><a class="dropdown-trigger white-text" href="#!" data-target="user_drop">View Basket<i class="material-icons right">arrow_drop_down</i></a>
...
<div class="row">
    ...
    <div class="row">
        ...
        <?php }else{?>
            <a href="#" class="btn waves-effect waves-light" type="submit" id="order" name="order">View Basket
