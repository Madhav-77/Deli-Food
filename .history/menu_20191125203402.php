    ...
    <div class="col s6 m3">
        <div class="card">
            ...
            <div class="card-content">
                ...
                <p style="float:left;" class="type"><?= $data['food_type'];?></p>
                <p style="float:right;" class="price"><?= $data['item_price'];?></p>
...
$('.plus').on('click', function(){
    ...
    var name = $order.find('p:nth-child(2)').text();
    var type = $order.find('p:nth-child(3)').text();
    var price = $order.find('p:nth-child(4)').text();
    console.log(name);
    console.log(type);
    console.log(price);
});
