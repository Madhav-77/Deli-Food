...
<form id="tests" method="POST"><input type="hidden" name="hid" value="hid"><input type="submit" id="hidsub"><div class="order-place"> </div></form>
...
$('#tests').submit(function(){
    $('#submit_basket').on('click', function(){
