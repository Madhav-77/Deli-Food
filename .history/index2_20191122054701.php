...
<head>
    ...
    <body>
        <div class="fixed-action-btn">
            ...
            <ul>
                <li><a class="btn-floating yellow darken-1"><i class="material-icons">library_books</i></a></li>
                <li><a href="#modal1" class="btn-floating red modal-trigger"><i class="material-icons">supervisor_account</i></a></li>
        ...
        <div id="modal1" class="modal modal-fixed-footer" style="height: 70%; width: 40%;">
                    ...
                    <form class="col s12" method="post" action="login.php">
                        ...
                        <div class="row">                          
                            <div class="input-field col s12" style="margin-bottom: 0px; margin-top: 0px;">
                                <button style="background-color: #F44336;" class="btn waves-effect waves-light" type="submit" name="action">Submit
            ...
            <div class="modal-footer center">
                <a href="#!" class="modal-close waves-effect waves-green btn-flat">Not a member yet?</a>
            </div>
        </div>
