    ...
    <div class="col s6 m3">
        <div class="card">
            ...
            <div class="card-action">
                <a class="waves-effect waves-teal btn-flat" style="float:left;">
                    <i class="minus material-icons">remove</i>
                </a>
                <a class="waves-effect waves-teal btn-flat" style="float:right;">
...
$('.minus').on('click', function(){
    var $n = $(this).parent('.btn-flat').parent('.card-action').find('.counter');
    var counter = $n.text();
    if(counter!=0){
        counter--;
    }
