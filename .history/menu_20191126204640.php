...
<?php if($id == 1) {?>
<h5 class="hide basket"><?= $_SESSION['username']; ?>'s Basket</h5>
<div class="order-place"> </div>
<a href="#!" class="basket hide btn waves-effect waves-light" type="submit" style="background: #F44336; float: right;">Place Order
    <i class="material-icons right">shopping_basket</i>
</a>
<?php }?>
