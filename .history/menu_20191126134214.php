...
$('.minus').on('click', function(){
    ...
    if(counter!=0){
        counter--;
        /* var name = $(this).parent('.breadcrums').parent('.card-action').siblings('.card-content').find('p:nth-child(1)').text();
        var price = $(this).parent('.breadcrums').parent('.card-action').siblings('.card-content').find('p:nth-child(3)').text();
        var count = counter;
        var total = count*price;
        $('.place-order').html("<tr><td>"+name+"</td><td>"+price+"</td><td>"+count+"</td><td>"+total+"</td></tr>"); */
    }
    $n.text(counter);
});
...
$('#order').on('click', function(){
    ...
    var html = "<table><thead><tr><th>Item Name</th><th>Item Price</th><th>Quantity</th><th>Total</th></tr></thead>";
        ";
    var i;
for(i=0; i<test.length; i++){
    //$('#place').html("<tbody><tr><td>"+test[i].name+"</td><td>"+test[i].price+"</td><td>"+test[i].count+"</td><td>"+test[i].total+"</td></tr></tbody>");
    //$('#place').html("<tr><td>"+test[i].name+"</td><td>"+test[i].price+"</td><td>"+test[i].count+"</td><td>"+test[i].total+"</td></tr>").appendTo($('#place'));
    //html+="<tr>";
