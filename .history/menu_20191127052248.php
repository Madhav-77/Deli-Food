...
<a href="#!" class="basket-ord hide btn waves-effect waves-light" id="submit_basket" type="submit" style="background: #F44336; float: right; margin: 13px; margin-bottom: 50px;">Place Order
